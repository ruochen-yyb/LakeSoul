...
public class LakeSoulDDLSinkOptions extends LakeSoulSinkOptions {
        ...
        public static final ConfigOption<String> SOURCE_DB_TABLE_LIST = ConfigOptions
                        .key("source_db.table.list")
                        .stringType()
                        .defaultValue("")
                        .withDescription(
                                        "list of source database tables to capture. Comma-separated table names or regex patterns. "
                                                        + "If empty, all tables in source_db.db_name will be captured.");
